...
ex) http://192.168.0.83:8090/WebJPS/ 엔터 하면 > 페이지 서비스 > default 페이지 구성 ...

/WebJSP >> 웹 프로젝트 이름, 가상 디렉토리, context root (문맥, 흐름, 전체)
/webJSP = context root
웹 경로 (가상경로) : http://192.168.0.83:8090/WebJPS/
>>실 경로 : /Users/yejin/Documents/Douzone/Web/WebClient/WebJSP/src/main/webapp/Ex08_Application.jsp 안에 있는 자원을 서비스 하겠다.
...
WEB-INF 보안 폴더 : Client 접근하게 되면 없는 페이지를 리턴 (접근 불가)

http://192.168.0.38:8090//WebJSP/WEB-INF/web.xml 엔터 서버는 404 전달

WEB-INF >> views >> member >> register.jsp 등등
				 >> admin  >> admin.jsp 
클라이언트 직접 보아서는 안되는 페이지는 보안 폴더에 숨김 ...^^
