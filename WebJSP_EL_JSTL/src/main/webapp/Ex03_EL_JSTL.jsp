...
<body>
	...
	<!-- 
	- **SP Standard Tag Library**의 약자로 JSP 표준 라이브러리이다.
	...
	– apache에서 다운받아 lib에 추가.
	 ...
	 <c:set var="m" value="<%=e%>"></c:set> <!-- // jstl로 사용된것은 el이 읽을 수 있다 -->
	 <br>
	 ...
	 잘쓰지 않아요 (재미로)<br>
	 <c:remove var="job2" />
	 변수가 없어요 (예외없이 값이 안나요) : ${job2} 
	 
	 <hr>
	 JAVA API 활용 객체는 (직접 만든 객체) 접근 안돼요 : ${hp}<br>
