...
<body>
	...
	<br>
	<a href="<%= request.getContextPath()%>/Board?cmd=boardlist">게시판 글쓰기</a>
	<br>
	...
	<a href="<%= request.getContextPath()%>/action.do?cmd=greeting">GET 요청</a>
	<br>
	
	<!-- 
	com.kosa > FrontServletController 서블릿 생성 > /action.do > doGET() 코드 작업
	view page > webapp > greeting.jsp
	cmd=greeting >> greeting 문자열이라면 Message 객체를 생성하고 ... 함수 parameter >> greeting 값을 준다.
	데이터 저장 >> msg 객체를 저장
	뷰페이지 >> greeting.jsp
	뷰페이지 >> 객체 출력!!
	 -->
