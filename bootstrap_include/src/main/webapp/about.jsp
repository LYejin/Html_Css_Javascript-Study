...
<body>
    ...
    <div class="swiper">
          ...
          <div class="song1">
            <div class="image1">
              <img
                ...
                id="songimg" style="width:200px; height: 200px;" />
            </div>
        ...
        <div class="swiper-slide">
          <div class="song1">
            ...
            <div class="iconc" id="m1">
              ...
              <img src="images/playb.png" id="playimg" class="p3">
      ...
      <div class="swiper-button-prev">
        ...
        <img src="images/prevplay.png" class="material-icons">
      </div>
      <div class="swiper-button-next">
        <!--      <div class="material-icons">arrow_forward</div>-->
        <img src="images/nextplay.png" class="material-icons">
      </div>
    </div>
  </main>
  	<jsp:include page="./footer.jsp" />
    <script src="js/localStorage.js" defer>
  </script>
</body>
</html>